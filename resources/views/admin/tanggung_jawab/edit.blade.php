...
style="position: relative;margin: auto;left:0;right:0;top:0; bottom:0;">
  <div class="card">
    <div class="card-body">
        ...
        action="{{ route('tanggungJawab.update', $data->id) }}">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-9">
                <input type="text" name="uraian" value="{{ $data->uraian }}" class="form-control">
              </div>
            </div>
          <center>
            <button type="submit" class="btn btn-primary mr-2">Simpan</button>
            <a href="{{ route('tanggungJawab.index') }}" class="btn btn-light" onclick="self.history.back()">Batal</a>
          </center>
        </form>
    </div>
  </div>
