...
<div class="row">
  <div class="col-lg-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        <h4 class="card-title">Risiko Bahaya</h4>
        <a href="<?php echo base_url('risiko_bahaya/add') ?>" class="btn btn-primary btn-rounded btn-fw">Tambah</a><br><br>
            ...
            <tbody>
              <?php $no=0; foreach ($query->result() as $key): ?>
                <tr>
                  ...
                  <td><?php echo $key->nama_resiko ?></td>
                  <td><?php echo $key->penyebab ?></td>
                  <td>
                    <a href="<?php echo base_url('risiko_bahaya/edit/'.$key->key) ?>"
											class="btn btn-inverse-success btn-fw">Edit</a>
                    <a href="<?php echo base_url('risiko_bahaya/delete/'.$key->key) ?>"
