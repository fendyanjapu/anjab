...
style="position: relative;margin: auto;left:0;right:0;top:0; bottom:0;">
  <div class="card">
    <div class="card-body">
        ...
        action="<?php echo base_url('kualifikasi_jabatan/update') ?>">
