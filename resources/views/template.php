...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets_admin/') ?>vendors/select2/select2.min.css">
    <link rel="stylesheet" href="<?php echo base_url('assets_admin/') ?>vendors/select2-bootstrap-theme/select2-bootstrap.min.css">
  ...
  <body>
        ...
        <div class="container-fluid">
          <div class="navbar-menu-wrapper d-flex align-items-center justify-content-between">
            ...
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                <a class="text-dark font-weight-bold mb-2" href="<?php echo base_url('admin') ?>">
                  <img src="<?php echo base_url('assets_admin/images/HOME_.png') ?>"
                  style="width:120px"></a><br>
            </div>
              <ul class="navbar-nav navbar-nav-right">
                <li class="nav-item dropdown d-lg-flex d-none">
                  <h5 class="text-dark font-weight-bold mb-2">
                       <?php echo $this->session->userdata('nama_sopd'); ?>
                  </h5>
                </li>
                <li class="nav-item dropdown d-lg-flex d-none">
    ...
    <!-- base:js -->
    <!-- <script src="<?php echo base_url('assets_admin/') ?>vendors/base/vendor.bundle.base.js"></script> -->
    <!-- endinject -->
    <!-- Plugin js for this page-->
    <!-- End plugin js for this page-->
    <!-- inject:js -->
    <script src="<?php echo base_url('assets_admin/') ?>js/template.js"></script>
    <!-- endinject -->
    <!-- plugin js for this page -->
    <script src="<?php echo base_url('assets_admin/') ?>vendors/typeahead.js/typeahead.bundle.min.js"></script>
    <script src="<?php echo base_url('assets_admin/') ?>vendors/select2/select2.min.js"></script>
    <!-- End plugin js for this page -->
