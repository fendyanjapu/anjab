...
<div class="row">
  <div class="col-lg-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        <h4 class="card-title">Iktisar Jabatan</h4>
        <a href="<?php echo base_url('iktisar/add') ?>" class="btn btn-primary btn-rounded btn-fw">Tambah</a><br><br>
            ...
            <tbody>
              <?php $no=0; foreach ($query->result() as $key): ?>
                <tr>
                  ...
                  <td><?php echo $key->iktisar ?></td>
                  <td>
                    <a href="<?php echo base_url('iktisar/edit/'.$key->key) ?>"
											class="btn btn-inverse-success btn-fw">Edit</a>
                    <a href="<?php echo base_url('iktisar/delete/'.$key->key) ?>"
