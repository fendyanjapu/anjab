  ...
  <div class="col-lg-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <a href="<?php echo base_url('hasil_kerja/add') ?>" class="btn btn-primary btn-rounded btn-fw">Tambah</a><br><br>
            ...
            <tbody>
              <?php $no=0; foreach ($query->result() as $key): ?>
                <tr>
                  ...
                  <td>
                    <a href="<?php echo base_url('hasil_kerja/edit/'.$key->key) ?>"
											class="btn btn-inverse-success btn-fw">Edit</a>
                    <a href="<?php echo base_url('hasil_kerja/delete/'.$key->key) ?>"
