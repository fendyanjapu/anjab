...
style="position: relative;margin: auto;left:0;right:0;top:0; bottom:0;">
  <div class="card">
    <div class="card-body">
        ...
        action="<?php echo base_url('syarat_jabatan/save') ?>">
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <input type="text" name="keterampilan_kerja" class="form-control">
            </div>
            ...
            <div class="col-sm-9">
              <div class="form-check">
                <label class="form-check-label">
                  <input type="radio" class="form-check-input" name="jenis_kelamin" value="Laki-laki" checked>
                  Laki-laki
                </label>
              </div>
              <div class="form-check">
            ...
            <div class="col-sm-9">
              <input type="text" name="postur_badan" class="form-control">
            </div>
            <label class="col-sm-3 col-form-label">Penampilan</label>
            <div class="col-sm-9">
              <input type="text" name="penampilan" class="form-control">
            </div>
