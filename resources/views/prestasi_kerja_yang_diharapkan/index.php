  ...
  <div class="col-lg-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <a href="<?php echo base_url('prestasi_kerja_yang_diharapkan/add') ?>"
            ...
            <tbody>
              <?php $no=0; foreach ($query->result() as $key): ?>
                <tr>
                  ...
                  <td>
                    <a href="<?php echo base_url('prestasi_kerja_yang_diharapkan/edit/'.$key->key) ?>"
											class="btn btn-inverse-success btn-fw">Edit</a>
                    <a href="<?php echo base_url('prestasi_kerja_yang_diharapkan/delete/'.$key->key) ?>"
