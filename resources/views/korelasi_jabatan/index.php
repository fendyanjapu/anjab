  ...
  <div class="col-lg-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <a href="<?php echo base_url('korelasi_jabatan/add') ?>" class="btn btn-primary btn-rounded btn-fw">Tambah</a><br><br>
            ...
            <tbody>
              <?php $no=0; foreach ($query->result() as $key): ?>
                <tr>
                  ...
                  <td><?php echo $key->nm_jabatan ?></td>
                  <td><?php echo $key->unit_kerja_instansi ?></td>
                  <td><?php echo $key->dalam_hal ?></td>
                  <td>
                    <a href="<?php echo base_url('korelasi_jabatan/edit/'.$key->key) ?>"
											class="btn btn-inverse-success btn-fw">Edit</a>
                    <a href="<?php echo base_url('korelasi_jabatan/delete/'.$key->key) ?>"
