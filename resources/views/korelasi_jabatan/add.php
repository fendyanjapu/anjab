<script>
	$(document).ready(function(){
		$('#jumlah_kolom').change(function(){
			...
			$.ajax({
				type   : "POST",
				url    : "<?php echo base_url('korelasi_jabatan/jml_kolom') ?>",
				data   : 'jml='+jml,
				cache  : false,
...
style="position: relative;margin: auto;left:0;right:0;top:0; bottom:0;">
  <div class="card">
    <div class="card-body">
        ...
        action="<?php echo base_url('korelasi_jabatan/save') ?>">
          ...
          <div id="kolom">
            <div class="form-group row">
              ...
              <div class="col-sm-9">
                <input type="text" name="nm_jabatan1" class="form-control">
              </div>
              <label class="col-sm-3 col-form-label">Unit Kerja/Instansi</label>
              <div class="col-sm-9">
                <input type="text" name="unit_kerja_instansi1" class="form-control">
              </div>
              <label class="col-sm-3 col-form-label">Dalam Hal</label>
              <div class="col-sm-9">
                <input type="text" name="dalam_hal1" class="form-control">
              </div>
            </div>
          </div>
          <center>
