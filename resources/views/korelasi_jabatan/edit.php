...
style="position: relative;margin: auto;left:0;right:0;top:0; bottom:0;">
  <div class="card">
    <div class="card-body">
        ...
        action="<?php echo base_url('korelasi_jabatan/update') ?>">
          <?php foreach ($query->result() as $key): ?>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-9">
                <input type="text" name="nm_jabatan" value="<?php echo $key->nm_jabatan ?>"class="form-control">
              </div>
              <label class="col-sm-3 col-form-label">Unit Kerja/Instansi</label>
              <div class="col-sm-9">
                <input type="text" name="unit_kerja_instansi" value="<?php echo $key->unit_kerja_instansi ?>"class="form-control">
              </div>
              <label class="col-sm-3 col-form-label">Dalam Hal</label>
              <div class="col-sm-9">
                <input type="text" name="dalam_hal" value="<?php echo $key->dalam_hal ?>"class="form-control">
              </div>
            </div>
          <?php endforeach; ?>
          <center>
