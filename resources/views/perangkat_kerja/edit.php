...
style="position: relative;margin: auto;left:0;right:0;top:0; bottom:0;">
  <div class="card">
    <div class="card-body">
        ...
        action="<?php echo base_url('perangkat_kerja/update') ?>">
          <?php foreach ($query->result() as $key): ?>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-9">
                ...
                value="<?php echo $key->perangkat_kerja ?>"class="form-control">
              </div>
              <label class="col-sm-3 col-form-label">Penggunaan Untuk Tugas</label>
              <div class="col-sm-9">
                <input type="text" name="penggunaan_untuk_tugas"
                value="<?php echo $key->penggunaan_untuk_tugas ?>"class="form-control">
              </div>
            </div>
          <?php endforeach; ?>
          <center>
