  ...
  <div class="col-lg-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <a href="<?php echo base_url('perangkat_kerja/add') ?>" class="btn btn-primary btn-rounded btn-fw">Tambah</a><br><br>
            ...
            <tbody>
              <?php $no=0; foreach ($query->result() as $key): ?>
                <tr>
                  ...
                  <td><?php echo $key->perangkat_kerja ?></td>
                  <td><?php echo $key->penggunaan_untuk_tugas ?></td>
                  <td>
                    <a href="<?php echo base_url('perangkat_kerja/edit/'.$key->key) ?>"
											class="btn btn-inverse-success btn-fw">Edit</a>
                    <a href="<?php echo base_url('perangkat_kerja/delete/'.$key->key) ?>"
